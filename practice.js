...
function doubleCheck(arr) {
  arr.includes('chocolate') ? arr : arr.push('chocolate'); 
  return arr; 
}
...
//Code Here
let dog = { name: '', color: '', age: 0, goodBoy: true }
...
//Code Here
// const outerFn = function() { return 'your name' }; 
// const outerFn = () => { () => { return 'your name' }; }
// const outerFn = () => () => { return 'your name' }; 
const outerFn = () => () => 'your name';
